# -*- coding: utf-8 -*-
'''
This code generates Fig. 3

Country-level temperature changes and the associated annual GDP increment induced by anthropogenic aerosols
...
of_plot = odir_plot + 'F3.Scatter_Changes_in_Temp_and_GDP.png'
...
ax.set_ylabel('GDP changes due to aerosol-induced cooling (%)',fontsize=16) 
