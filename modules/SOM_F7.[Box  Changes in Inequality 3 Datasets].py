...
'''
This code generates Fig. S17

Impact of aerosol-induced cooling on country-level economic inequality based on different climatological temperature datasets.
...
for ids, ds in enumerate(datasets):
    ...
    plt.text(0.03,0.97, (chr(ord('a') + ids) + ' '+ds),size=16, horizontalalignment='left',#fontweight = 'bold',
